...
extension UIColor {
    public static let searchText = CommonAsset.searchText.color
    public static let yellowBus = CommonAsset.yellowBus.color
    public static let redBus = CommonAsset.redBus.color
